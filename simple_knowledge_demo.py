...
class SimpleKnowledgeDemo:
    ...
    def __init__(self, model_name: str = "TinyLlama/TinyLlama-1.1B-Chat-v1.0"):
        ...
        # System prompt to ensure "I don't know" responses
        self.safe_prompt = "You are a helpful assistant. If you don't know something or aren't sure, always say 'I don't know' rather than guessing."
    ...
    def ask_model(self, question: str, use_trained: bool = False) -> Tuple[str, float]:
        ...
        # Add safety prompt for base model
        if not use_trained:
            prompt = f"<|system|>{self.safe_prompt}<|user|>{question}<|assistant|>"
        else:
